...
namespace PCL
{
    public class MyComboBoxItem : ComboBoxItem
    {
        ...
        private void RefreshColor()
        {
            ...
            {
                // 有动画
                ModAnimation.AniStart(new[] { ModAnimation.AaColor(this, BackgroundProperty, BackColorName, Time), ModAnimation.AaOpacity(this, FontOpacity - Opacity, Time) }, "ComboBoxItem Color " + Uuid);
            }
            else
            {
                // 无动画
